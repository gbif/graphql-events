...
module.exports = {
  ...
  Event: {
    ...
    measurementOrFactTypes: (parent) => (parent.event.event ? parent.event.event.measurementOrFactTypes: null),
    measurementOrFactCount: (parent) => (parent.event.event ? parent.event.event.measurementOrFactCount: null),
